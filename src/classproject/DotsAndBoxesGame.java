...
public class DotsAndBoxesGame {
    ...
    private final List<JPanel> box1 = new ArrayList<>();
    private final List<JPanel> box2 = new ArrayList<>();
    private final List<JPanel> box3 = new ArrayList<>();
    private final List<JPanel> box4 = new ArrayList<>();
    private final List<JPanel> box5 = new ArrayList<>();
    private final List<JPanel> box6 = new ArrayList<>();
    private final List<JPanel> box7 = new ArrayList<>();
    private final List<JPanel> box8 = new ArrayList<>();
    private final List<JPanel> box9 = new ArrayList<>();
    private final List<JPanel> box10 = new ArrayList<>();
    private final List<JPanel> box11 = new ArrayList<>();
    private final List<JPanel> box12 = new ArrayList<>();
    private final List<JPanel> box13 = new ArrayList<>();
    private final List<JPanel> box14 = new ArrayList<>();
    private final List<JPanel> box15 = new ArrayList<>();
    private final List<JPanel> box16 = new ArrayList<>();
    private final List<JPanel> box17 = new ArrayList<>();
    private final List<JPanel> box18 = new ArrayList<>();
    
    // BIGGG box map!
    private List<List<JPanel>> boxMap = new ArrayList<>();
    ...
    private void resetLinesRecursively(int index){
